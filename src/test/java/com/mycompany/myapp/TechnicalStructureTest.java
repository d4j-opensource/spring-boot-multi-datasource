...
@AnalyzeClasses(packagesOf = SpringBootMultiDatasourceApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(SpringBootMultiDatasourceApp.class), alwaysTrue())
